...
class TestInteractiveAgentViewTemplate(unittest.TestCase):
    def test_generated_chat_has_fullscreen_interactive_agent_view(self):
        ...
        self.assertIn("function agentViewStylesheetReplayStatus", html)
        self.assertIn("stylesheet replays failed; computed fallback active", html)
        self.assertIn("inline styles bounded", html)
