"""Research Desk page builder.

Keep the large hosted/local handoff UI out of the request-handler module so the
route layer stays readable and other agents can find the actual page code
quickly.
"""
...
def build_research_desk_html(*, authenticated: bool, sign_in_url: str = "/trial") -> str:
