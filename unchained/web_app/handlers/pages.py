...
<body>
  ...
  <script>
    ...
    try{const existingPrompt=currentPromptFromContext();if(existingPrompt){setConnectNote('Ready to hand off the current first-look prompt into your local desk once the connection is approved.');}}catch(_err){}
    loadDeskState();
  </script>
</body>
</html>"""
