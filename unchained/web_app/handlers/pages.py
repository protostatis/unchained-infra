...
<body>
  ...
  <script>
    ...
    function safeLocalUrl(value){try{const url=new URL(String(value||'http://127.0.0.1:8766/'));if(url.protocol!=='http:'&&url.protocol!=='https:') return 'http://127.0.0.1:8766/';const host=url.hostname.toLowerCase();if(host!=='127.0.0.1'&&host!=='localhost') return 'http://127.0.0.1:8766/';return url.toString();}catch(_err){return 'http://127.0.0.1:8766/';}}
