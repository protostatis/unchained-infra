    ...
    <section class="hero">
      ...
      <div class="panel">
        ...
        <div class="status-shell">
          <div class="status-card"><strong>1. Install the local agent</strong><p>Use <a href="/install" style="color:var(--accent)">the installer flow</a> if Research Desk is not installed on this machine yet.</p></div>
          <div class="status-card"><strong>2. Start the browser bridge</strong><p>Run <code>uv run unchained-pyreplab bridge-start</code> on this machine.</p></div>
          <div class="status-card"><strong>3. Start Research Desk</strong><p>Run <code>./scripts/serve_with_codex.sh</code> or <code>uv run unchained-pyreplab serve --open --reload</code>.</p></div>
          <div class="status-card"><strong>4. Return here</strong><p>This page probes <code>127.0.0.1:8766</code> for the local status and recent mission summaries.</p></div>
        </div>
      </div>
    </section>
    <section class="grid">
