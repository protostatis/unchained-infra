...
class TestWebTemplateContracts(unittest.TestCase):
    ...
    def test_research_desk_page_renders_phase3_connect_markers(self):
        ...
        self.assertIn("const preferredUrl=safeOptionalLocalUrl(data.preferred_open_url_abs||data.lab_url_abs||data.mission_url_abs||data.capsule_url_abs||'')", html)
        self.assertIn("const preferredLabel=String(data.preferred_open_label||'Open Current Best View')", html)
